...
// Build TOML config for NovaRoute (openai provider mode)
const buildNovaRouteConfig = (baseUrl, apiKey, model) => {
...
// Detect NovaRoute by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildNovaRouteConfig(baseUrl, apiKey || "sk_NovaRoute", model);
