...
import { AI_PROVIDERS, FREE_TIER_PROVIDERS, WEB_COOKIE_PROVIDERS, NOAUTH_PROVIDERS, isOpenAICompatibleProvider, isAnthropicCompatibleProvider, isCustomEmbeddingProvider } from "@/shared/constants/providers";
...
export async function POST(request) {
  try {
    ...
    // Local/no-auth runtimes (ollama-local, llamafile, vllm…) need no key at all.
    const isNoAuthProvider = !!NOAUTH_PROVIDERS[provider] || !!AI_PROVIDERS[provider]?.noAuth || AI_PROVIDERS[provider]?.category === "local";
