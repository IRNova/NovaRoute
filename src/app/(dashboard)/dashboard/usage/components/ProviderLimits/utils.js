...
export function getConnectionsEmptyMessage(totals, providerFilter, accountFilter, options = {}) {
  ...
  if (options.search) {
    return {
      ...
      description: `Nothing found for “${options.search}”. Try a different name or email.`,
    };
  }
