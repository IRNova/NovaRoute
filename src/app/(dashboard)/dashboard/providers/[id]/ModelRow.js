...
export default function ModelRow({ model, fullModel, alias, copied, onCopy, testStatus, testError, isCustom, isFree, onDeleteAlias, onTest, isTesting, onDisable, caps, thinkingSuffix }) {
      ...
      <div className="flex min-w-0 items-start gap-2 sm:items-center">
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-1">
          ...
          {testStatus === "error" && testError && (
            <span
              className="max-w-[72vw] truncate rounded bg-red-500/10 px-1.5 py-0.5 font-mono text-[9px] text-red-500 sm:max-w-[360px]"
              title={testError}
            >
              {testError}
            </span>
