...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div
        className={cn(
          // bg-elevated, not bg-surface: surfaces are translucent in the Nova
          // dark palette, and a floating panel must not let the page bleed
          // through it.
          "relative w-full bg-elevated",
          "border border-border",
          "rounded-brand-lg shadow-[var(--shadow-elev)]",
          "fade-in",
          sizes[size],
          className
        )}
