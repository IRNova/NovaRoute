...
export default function AuthLayout({ children }) {
  return (
    <div className="min-h-screen flex flex-col relative bg-bg transition-colors duration-500 overflow-x-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <div className="fixed bottom-0 right-0 w-[600px] h-[600px] bg-[color-mix(in_srgb,var(--violet)_10%,transparent)] rounded-full blur-[120px] pointer-events-none z-0 translate-y-1/3 translate-x-1/3" />
