...
export default function ChangelogModal({ isOpen, onClose }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ref={modalRef}
        className="relative w-full bg-elevated border border-border rounded-brand-lg shadow-[var(--shadow-pop)] animate-in fade-in zoom-in-95 duration-200 max-w-3xl flex flex-col max-h-[85vh]"
      >
        {/* Header */}
