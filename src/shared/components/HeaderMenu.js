  ...
  return (
    <>
      <div className="relative" ref={menuRef}>
        ...
        {isOpen && (
          <div className="absolute end-0 top-full mt-2 w-60 bg-elevated border border-border rounded-brand-lg shadow-[var(--shadow-pop)] z-50 animate-in fade-in zoom-in-95 duration-150 overflow-hidden py-1">
            <MenuItem
              icon="history"
              label="Change Log"
