        ...
        {selectedMethod === "social-google" && (
          <div className="space-y-4">
            <div className="bg-warning/10 p-4 rounded-lg border border-warning/30">
              <div className="flex gap-2">
                <span className="material-symbols-outlined text-warning dark:text-warning">info</span>
              ...
              <>
                ...
                {autoDetected && (
                  <div className="bg-success/10 p-3 rounded-lg border border-success/30">
                    <div className="flex gap-2">
                      <span className="material-symbols-outlined text-success dark:text-success">check_circle</span>
