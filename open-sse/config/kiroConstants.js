 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what NovaRoute needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a NovaRoute
 ...
 * The suffix is a NovaRoute request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a NovaRoute synthetic agentic variant.
...
/**
 * Detect whether a model id is a NovaRoute synthetic thinking variant
...
/**
 * Resolve a NovaRoute model id to the real upstream Kiro model id, plus flags
