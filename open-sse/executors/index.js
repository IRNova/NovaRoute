...
import { LmStudioLocalExecutor } from "./lm-studio-local.js";
import { LlamacppLocalExecutor } from "./llamacpp-local.js";
...
const executors = {
  ...
  "ghe-copilot": new GithubExecutor("ghe-copilot"),
  ...
  "lm-studio-local": new LmStudioLocalExecutor(),
  "llamacpp-local": new LlamacppLocalExecutor(),
  ...
  // Agentic bridge shares the same ACP stdio binary/executor.
  "devin-cli-agentic": new DevinCliExecutor(),
};
...
export { LmStudioLocalExecutor } from "./lm-studio-local.js";
export { LlamacppLocalExecutor } from "./llamacpp-local.js";
