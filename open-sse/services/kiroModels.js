 ...
 * into NovaRoute-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are NovaRoute fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic NovaRoute variant set for a single upstream Kiro model.
 *
 ...
 * into NovaRoute variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
