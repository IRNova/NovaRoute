...
export {
  // xAI was missing here while src/app/api/providers/[id]/models/route.js
  // imports it — the import resolved to undefined and refreshing an expired
  // xAI token threw "refreshXaiToken is not a function".
  refreshXaiToken,
  refreshAccessToken,
  refreshKimiToken,
  refreshClaudeOAuthToken,
