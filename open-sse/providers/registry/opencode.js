export default {
  ...
  // Seed catalog mirrors the live https://opencode.ai/zen/v1/models listing
  // (keyless "-free" ids first — paid ids need an API key at request time).
  // Context lengths cross-referenced from sibling registries (devin-cli-agentic,
  // bazaarlink) which carry the same underlying models.
  models: [
    { id: "nemotron-3-ultra-free", name: "Nemotron 3 Ultra (Free)", contextLength: 262144 },
    { id: "laguna-s-2.1-free", name: "Laguna S 2.1 (Free)", contextLength: 131072 },
    { id: "hy3-free", name: "HY3 (Free)", contextLength: 204800 },
    { id: "nemotron-3.5-lightning-free", name: "Nemotron 3.5 Lightning (Free)", contextLength: 262144 },
    { id: "x-preview-f-free", name: "X Preview F (Free)", contextLength: 131072 },
    { id: "mimo-v2.5-free", name: "MiMo v2.5 (Free)", contextLength: 1050000 },
    { id: "muse-spark-1.2-contributor-free", name: "Muse Spark 1.2 Contributor (Free)", contextLength: 131072 },
    ...
    { id: "kimi-k3", name: "Kimi K3", contextLength: 200000 },
    { id: "qwen3.6-plus", name: "Qwen3.6 Plus", contextLength: 1000000 },
    { id: "big-pickle", name: "Big Pickle", contextLength: 200000 },
    { id: "muse-spark-1.2", name: "Muse Spark 1.2", contextLength: 131072 },
    ...
    { id: "gemini-3.6-flash", name: "Gemini 3.6 Flash", contextLength: 200000 },
    ...
    { id: "gpt-5.5-pro", name: "GPT-5.5 Pro", contextLength: 272000 },
    ...
    { id: "qwen3.5-plus", name: "Qwen3.5 Plus", contextLength: 1000000 },
  ],
