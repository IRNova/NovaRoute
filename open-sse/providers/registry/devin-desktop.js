export default {
  ...
  display: {
    ...
    notice: {
      text: "Devin Desktop is a Windows/macOS desktop application - it cannot be installed or run on a headless server. Use Devin CLI Agentic Bridge instead, or paste a Devin API key here if you have one from a desktop session.",
    },
  },
  category: "cli",
