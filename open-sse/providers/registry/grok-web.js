export default {
  ...
  cookieHint: "Open DevTools → Application → Cookies → grok.com → copy sso",
  transport: {
    cookieName: "sso",
  ...
  credentialFields: [
    { id: "sso", label: "sso", placeholder: "eyJ0eXAi...", required: true, hint: "DevTools > Application > Cookies > grok.com > sso" },
    { id: "sso_rw", label: "sso_rw", required: true, hint: "Same page > sso_rw cookie (required by most accounts)" },
    { id: "cf_clearance", label: "cf_clearance (optional)", required: false, hint: "Only if Cloudflare challenges your server IP" },
  ],
};
