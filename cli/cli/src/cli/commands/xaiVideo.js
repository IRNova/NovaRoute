/**
 * `NovaRoute xai video` — generate a Grok Imagine video through the local
 * NovaRoute gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: NovaRoute xai video --prompt "..." [options]

Generate a Grok Imagine video via your local NovaRoute gateway
...
Options:
  ...
  --api-key <key>         NovaRoute API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-NovaRoute-connection-id"] || null;
