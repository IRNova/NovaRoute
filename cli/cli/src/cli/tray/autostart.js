...
const APP_NAME = "novaroute";
const APP_LABEL = "com.novaroute.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when NovaRoute is currently
 ...
 * SIGTERM to the running process. When the running NovaRoute cli.js was itself
...
<dict>
    ...
    <string>/tmp/NovaRoute.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/NovaRoute.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `NovaRoute.cmd` lookup that depended on the npm prefix path.
