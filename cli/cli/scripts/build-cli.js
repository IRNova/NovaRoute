...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/NovaRoute/server.js.
...
function buildCliPackage() {
  console.log("📦 Building NovaRoute CLI package with Next.js...\n");
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.novaroute/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.novaroute/runtime)");
  }
  console.log("");
